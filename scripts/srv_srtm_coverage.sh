...
gmt grdmath -R0/360/-60/60 @earth_mask_15s_p 0 EQ = /tmp/ocean.nc=nb
gmt grd2xyz /tmp/ocean.nc | gmt xyz2grd -R-180/180/-60/60 -I1 -r -Au -G/tmp/ocean_tile.nc=ns -V -fg
# 3. Combine the tile and 2xocean files to yield the 0,1,2 final grid
gmt grdmath /tmp/ocean_tile.nc 2 MUL /tmp/srtm.nc ADD = srtm_tiles.nc=nb --IO_NC4_DEFLATION_LEVEL=9
